...
public class GrabBlurTargetLayerFeature : ScriptableRendererFeature
{
    [System.Serializable]
    public class Settings
    {
        public string TextureName = "_GrabTargetLayer";
        public Shader shader;
        [HideInInspector]
        public float blurSize = 3.0f;
    }

    class GrabBlurTargetLayerPass : ScriptableRenderPass
    {
        private const string ProfilerTag = nameof(GrabBlurTargetLayerPass);
        ...
        public GrabBlurTargetLayerPass(Settings Settings, RenderPassEvent RenderPassEvent)
        {
            settings = Settings;
        ...
        public override void Configure(CommandBuffer cmd, RenderTextureDescriptor cameraTextureDescriptor)
        {
            ...
            cmd.SetGlobalTexture(settings.TextureName, tempColorTarget2.Identifier());
        }
    ...
    GrabBlurTargetLayerPass grabPass;
    ...
    {
        grabPass = new GrabBlurTargetLayerPass(settings, renderPassEvent + OrderInSortLayer);
    }
